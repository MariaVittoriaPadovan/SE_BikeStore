...
class View:
    ...
    def load_interface(self):
        ...
        # Riga 1
        self.dd_category = ft.Dropdown(label="Categoria", width=200, on_change=self.controller.choice_category) # TODO: Gestire il dropdown
        ...
        self.dd_prodotto_iniziale = ft.Dropdown(label="Prodotto Iniziale", width=350, on_change=self.controller.choice_prod_start) # TODO: Gestire il dropdown
        self.dd_prodotto_finale = ft.Dropdown(label="Prodotto Finale", width=350, on_change=self.controller.choice_prod_end) # TODO: Gestire il dropdown
